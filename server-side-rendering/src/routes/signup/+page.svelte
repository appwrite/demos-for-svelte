...
<div class="u-max-width-500 u-width-full-line">
	...
	<div class="u-margin-block-start-24">
		<form class="form common-section" method="POST">
			<ul class="form-list" style="--form-list-gap: 1.5rem;">
				...
				<li class="form-item">
					<button class="button is-github is-full-width" type="button" on:click={signInWithGithub}>
	...
	<ul class="inline-links is-center is-with-sep u-margin-block-start-32">
		<li class="inline-links-item">
			<span class="text">Already got an account? <a class="link" href="/signin">Sign in</a></span>
		</li>
	</ul>
</div>
